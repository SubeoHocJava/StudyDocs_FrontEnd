          ...
          return Scaffold(
            ...
            body: state.isTrashMode
              ...
              onToggleSelection: (id) {
                context.read<NotificationBloc>().add(ToggleTrashSelectionEvent(id));
              },
              onRestore: (id) {
              ...
              onRestoreAllSelected: () {
                context.read<NotificationBloc>().add(RestoreAllSelectedEvent());
              },
              onDeleteAllSelected: () {
                context.read<NotificationBloc>().add(DeleteAllSelectedEvent());
              },
            )
