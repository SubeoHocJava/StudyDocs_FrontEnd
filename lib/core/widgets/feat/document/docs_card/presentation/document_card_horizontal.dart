...
/// Card ngang — nhận [doc] và callbacks từ page/Bloc. Không chứa logic, chỉ hiển thị.
class DocumentCardHorizontal extends StatelessWidget {
  ...
  Widget _placeholderIcon() =>
      const Icon(Icons.picture_as_pdf, size: 36, color: AppColors.gray);
  ...
  Widget _buildRightSection() {
    return Column(
      ...
      children: [
        // Expanded: ép cụm info chỉ chiếm phần còn lại (trừ hàng action), không tràn
        Expanded(
          child: ClipRect(
