class ApiConstants {
  ...
  static const String documentServiceUrl = 'http://localhost:8085/api/v1'; // Use localhost for Web
  static const String reviewServiceUrl = 'http://localhost:8086/api/v1';   // Use localhost for Web
