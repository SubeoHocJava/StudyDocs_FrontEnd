class ApiConstants {
  ...
  static const String reviewBaseUrl =
      'http://172.16.17.80:8080/api/v1'; // Same as base in current local config
  ...
  static const String popularDocuments =
      '/documents/popular'; // Old mock endpoint
  static const String popularDocumentsReal =
      '/internal/documents/most-liked'; // ✅ Real API
  static const String recentDocuments =
      '/documents/recent'; // Old mock endpoint
  static const String recentDocumentsReal =
      '/internal/documents/newest'; // ✅ Real API
