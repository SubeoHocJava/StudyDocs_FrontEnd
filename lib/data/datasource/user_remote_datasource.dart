...
abstract interface class UserRemoteDataSource {
  ...
  /// Count documents of current user
  Future<ApiResponse> getMyDocumentCount({String? traceId});

  /// ===============================
  /// REVIEW / REACTION
  /// ===============================
  /// Count reactions of current user (LIKE, DISLIKE...)
  Future<ApiResponse> getMyReactionCount(String type, {String? traceId});

  /// Count reviews of a user by userId
  Future<ApiResponse> getUserReviewCount(String userId, {String? traceId});
}
