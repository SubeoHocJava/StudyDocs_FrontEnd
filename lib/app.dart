...
import 'core/feat/notification/logic/notification_state.dart';
...
import 'core/feat/notification/presentation/widgets/notification_options_bottom_sheet.dart';
import 'core/feat/notification/presentation/widgets/global_notification_options_bottom_sheet.dart';
import 'core/feat/notification/presentation/widgets/active_notification_list.dart';
import 'core/feat/notification/presentation/widgets/trash_notification_list.dart';
      ...
      home: MultiRepositoryProvider(
        ...
        child: MultiBlocProvider(
          ...
          child: BlocBuilder<NotificationBloc, NotificationState>(
            builder: (c, state) {
              if (state is NotificationLoaded) return Scaffold(appBar: AppBar(title: const Text('Trash')), body: TrashNotificationList(trashList: state.trashNotifications, selectedTrashIds: [], onToggleSelection:(_){}, onRestore:(_){}, onDelete:(_){}, onRestoreAllSelected:(){}, onDeleteAllSelected:(){}));
